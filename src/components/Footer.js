      ...
      <footer className="footer-section">
            ...
            <div className="row">
              <div className="col-lg-3 col-md-6 col-sm-6">
                <div className="widget company-intro-widget">
                  <Link to="/">
                    <img src={logo} alt="" width="150px" className="my-3" />
                  </Link>
                  <p>
                  ...
                  <ul className="company-footer-contact-list">
                    ...
                    <li>
                      <i className="fas fa-clock"></i>Mon - Sat 11.00 - 7.00
                    </li>
                  </ul>
                </div>
              </div>
              <div className="col-lg-3 col-md-6 col-sm-6">
                <div className="widget course-links-widget">
                  ...
                  <ul className="courses-link-list">
                    ...
                    <li>
                      <a href="./">
                        <i className="fas fa-long-arrow-alt-right"></i>UI/UX
                        Design
                      </a>
                    </li>
                    <li>
                      <a href="./">
                        <i className="fas fa-long-arrow-alt-right"></i>PC
                        Systems
                      </a>
                    </li>
                    <li>
        ...
        <div className="footer-bottom">
          <div className="container">
            ...
            <div className="text-center"> Designed By - Praveen Kumar</div>
          </div>
        </div>
      </footer>
    </>
